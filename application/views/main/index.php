                ...
                function data_change( data ) {
                    ...
                    for(var countA = 0; countA < data.StoryList.length; countA++){
                        output = "<div class='mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp'>" +
                            "<figure class='blurfilter blurrotate'>" +
                            "<div class='demo-card-square'>";
                            if(data.StoryList[countA].StoryRepresentImage) {
                                output += "<img src='/images/story_represent_image/"+data.StoryList[countA].StoryRepresentImage+"."+data.StoryList[countA].StoryRepresentImageExt+"' style='width:100%; min-height:85%;'>";
                            } else {
                                output += "<img src='/images/story_represent_image/basic.jpg'>";
                            }
